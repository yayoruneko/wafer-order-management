const en = {
  ...
  statsCharts: {
    title: 'Statistics',
    subtitle: 'Operations overview (super admin only)',
    loading: 'Loading statistics…',
    loadError: 'Could not load statistics. Please try again.',
    empty: 'No data available to analyze yet.',
    ordersUnit: 'orders',
    wafersUnit: 'wafers',
    statusDist: 'Order status distribution',
    dailyUtil: 'Daily capacity utilization',
    used: 'Used',
    capacity: 'Capacity',
    utilizationPct: 'Utilization %',
    delayDist: 'On-time vs delayed',
    onTime: 'On time',
    delayBuckets: {
      onTime: 'On time',
      d1_3: 'Delayed 1–3d',
    ...
    customerTop: 'Top 8 customers by wafers',
    creatorWorkload: 'Orders by creator',
